...
const isReceiveEntitiesAction = (payload: any): payload is {entities: Entities} => {
 ...
 */
const readingsByList = (state: ReadingListState = {}, action: ReadingListActionTypes): ReadingListState => {
    switch (action.type) {
