...
export type SearchAllAction = ThunkAction<Promise<void>, RootState, unknown, Action>
export type SearchUsersAction = ThunkAction<Promise<void>, RootState, unknown, Action>
