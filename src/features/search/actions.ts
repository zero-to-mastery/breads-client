...
import { SearchActionTypes, SearchAllAction, SearchState, SearchUsersAction } from './types';
...
export const searchUsers = (search: string): SearchUsersAction => async dispatch => {
    dispatch(addLoader('search'));
