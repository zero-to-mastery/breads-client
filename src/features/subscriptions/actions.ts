...
import { fetchingSubscriptions, removingSubscription, postingNewSubscription, fetchingSubscriptionsIfNeeded } from "./types";
...
export const fetchSubscriptions = (user_id: number): fetchingSubscriptions => async (dispatch) => {
...
export const removeSubscription = (sub_id: number, pub_id: number): removingSubscription => {
    return (dispatch) => {
...
export const postNewSubscription = (sub_id: number): postingNewSubscription => (dispatch, getState) => {
...
const shouldFetchSubscriptions = (state: any, id: number): boolean | undefined => {
...
export const fetchSubscriptionsIfNeeded = (id: number): fetchingSubscriptionsIfNeeded => {
